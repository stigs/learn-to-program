...
def build_rating_list(name_to_rating, names):
    ...
    for name in names:
        ...
        results.append([int(name_to_rating[name]), name])
...
def filter_by_cuisine(names_matching, cuisine_to_names, cuisines_list):
    ...
    # For each name in the matching names list, check to see if it appears in the list of names by cuisine
